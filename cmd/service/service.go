...
import (
	...
	http "github.com/progoci/progo/services/container/pkg/http"
	service "github.com/progoci/progo/services/container/pkg/service"
...
var fs = flag.NewFlagSet("container", flag.ExitOnError)
...
func Run() {
	...
	if *zipkinURL != "" {
		...
		recorder := zipkingoopentracing.NewRecorder(collector, false, "localhost:80", "container")
